...
- **True o False**:La condición se valúa como True o False.
##[Condición else](#Condición else)
- **else **: else caotura todo lo que no cumple la condición if 
- **No lleva la condición**
##[Condición elif](#Condición elif)
- **Python evalúa las condiciones de arriba hacia abajo**
- **La primera que sea True se <b>ejecuta</b> y el resto se ignora**
